...
interface ITwitchClipRepository {
   save(clip: TwitchClipData): Promise<ITwitch>;
   update(clip: TwitchClipData): Promise<ITwitch>;
   retrieveById(id: string): Promise<ITwitch | undefined>;
}

class TwitchClipRepository implements ITwitchClipRepository {
   save(clip: TwitchClipData): Promise<ITwitch> {
